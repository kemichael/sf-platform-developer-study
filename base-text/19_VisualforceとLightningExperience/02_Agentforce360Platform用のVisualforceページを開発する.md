...
```text
   ┌──────────────────────────────┐      ┌──────────────────────────────┐
   │  /apex/PageName              │      │  /lightning                  │
   │  （従来の Visualforce コンテナ）│      │  （Lightning Experience コンテナ）│
   │                              │      │                              │
   │  ➜ 常に Salesforce Classic   │      │  ➜ この中で VF を開くと        │
   │     で表示される              │      │     LEX の挙動を確認できる      │
   └──────────────────────────────┘      └──────────────────────────────┘
            この 2 つの URL は重複せず、別々の世界として動く
```
